...
if __name__ == '__main__':
    ...
    while botRunning:
        ...
        if sameLettersCount > 1 and too_many_i(letters):
            ...
            letterColor = 'white'
            continue
        # screen doesn't change fast enough after completion, maybe don't need this?
        if letters == oldLetters and sameLettersCount < 3:
            print(f'same letters, retrying: {oldLetters}')
            time.sleep(1)
            continue
